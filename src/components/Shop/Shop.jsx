  ...
  return (
    <>
      <section className="grid grid-cols-1 md:grid-cols-2 gap-7 p-4  mt-12 mb-12 container mx-auto px-5 lg:px-20 ">
        <div
          className="border bg-[url(src/assets/sofa.jpg)] bg-no-repeat bg-cover bg-center
        ...
        <div className="grid grid-cols-1 gap-9 ">
          <div className="border bg-[url(src/assets/watch.jpg)] py-8 px-10 bg-no-repeat bg-cover bg-center">
            <h3 className="text-gray-500 pb-2 font-medium">#Accessories</h3>
            <h2 className="font-semibold lg:text-3xl">
              Discover Our Accessories Collection
            </h2>
          </div>
          <div className="border bg-[url(src/assets/laptopImage.jpg)] p-10 bg-no-repeat bg-cover bg-center">
